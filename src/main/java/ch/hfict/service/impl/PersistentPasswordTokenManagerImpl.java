...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see ch.hfict.service.impl.PasswordTokenManager#generateRecoveryToken(ch.hfict.model.User)
     */
    @Override
    ...
    /**
     * @see ch.hfict.service.impl.PasswordTokenManager#isRecoveryTokenValid(ch.hfict.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see ch.hfict.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
