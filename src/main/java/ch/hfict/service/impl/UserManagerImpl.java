package ch.hfict.service.impl;

import org.apache.commons.lang.StringUtils;
import ch.hfict.dao.UserDao;
import ch.hfict.model.User;
import ch.hfict.service.MailEngine;
import ch.hfict.service.UserExistsException;
import ch.hfict.service.UserManager;
import ch.hfict.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "ch.hfict.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see ch.hfict.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
